...
![Pasted image 20251028133137](Pasted%20image%2020251028133137.png)
...
![Pasted image 20251028180718](Pasted%20image%2020251028180718.png)
`Task manager method`
...
![Pasted image 20251028204036](Pasted%20image%2020251028204036.png)
...
A [Pass the Hash (PtH)](PtH)) attack is a technique where an attacker uses a password hash instead of the plain text password for authentication. The attacker doesn't need to decrypt the hash to obtain a plaintext password
...
Another method for moving laterally in an Active Directory environment is called a [Pass the Ticket (PtT) attack](PtT)%20attack). In this attack, we use a stolen Kerberos ticket to move laterally instead of an NTLM password hash
