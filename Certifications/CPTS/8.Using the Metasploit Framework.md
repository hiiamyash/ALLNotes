...
|                                                                                                                     |                                                                                                                                     |                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [[pre-installed)](pre-installed|nMap (pre-installed)]])                                                                            | [[pre-installed)](pre-installed|NexPose (pre-installed)]])                                                                       | [[pre-installed)](pre-installed|Nessus (pre-installed)]])                                               |
| [[pre-installed V.1)](pre-installed V.1|Mimikatz (pre-installed V.1)]])                                                 | [[pre-installed)](pre-installed|Stdapi (pre-installed)]]) | [Railgun](https://github.com/rapid7/metasploit-framework/wiki/How-to-use-Railgun-for-Windows-post-exploitation) |
| [Priv](https://github.com/rapid7/metasploit-framework/blob/master/lib/rex/post/meterpreter/extensions/priv/priv.rb) | [[pre-installed)](pre-installed|Incognito (pre-installed)]])                                 | [Darkoperator's](https://github.com/darkoperator/Metasploit-Plugins)                                            |
