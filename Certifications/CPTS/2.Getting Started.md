...
![Pasted image 20250412162023](../../attchments/Pasted%20image%2020250412162023.png)

![Pasted image 20250412162949](../../attchments/Pasted%20image%2020250412162949.png)
...
|Switch between panes|`[CTRL + B]` then `←` `→` `↑` `↓`|Moves the cursor to the pane in the direction of the arrow key.|
...
SNMP stands for **Simple Network Management Protocol**. It’s like a language used by network devices (like routers, switches, printers) to report their status or receive commands. Think of it like asking a device, “Hey, how are you doing?” and it replies with useful info.
...
In older SNMP versions (v1 and v2c), this "password" is sent **in plain text** — no encryption, no protection. If you guess or find the string, you can:
...
![Pasted image 20250415145852](../../attchments/Pasted%20image%2020250415145852.png)

```
nc -lvnp 1234
```

![Pasted image 20250415150046](../../attchments/Pasted%20image%2020250415150046.png)

## Upgrading TTY

### 🔹 What is a TTY?

**TTY** stands for **teletypewriter**, but don’t let the old-school name confuse you. In today's context, it's just a **fancy name for a terminal**
...
![Pasted image 20250415151250](../../attchments/Pasted%20image%2020250415151250.png)
...
![Pasted image 20250415151456](../../attchments/Pasted%20image%2020250415151456.png)

## Privilege Escalation


[Linpriv Cheet](Linpriv%20Cheet.md.md)

[WinPriv Cheet](WinPriv%20Cheet.md.md)
...
![Pasted image 20250415221830](../../attchments/Pasted%20image%2020250415221830.png)
