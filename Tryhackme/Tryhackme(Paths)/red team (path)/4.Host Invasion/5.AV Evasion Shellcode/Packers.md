...
above command to create an shellcode

then put the shellcode in the shellcode variable

```
csc UnEncStagelessPayload.cs
```

aboove command to compile

ater this try upload it to an AV it will be fflagged o now we will be using the ConfuserEx
